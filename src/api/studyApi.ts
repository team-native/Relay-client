...
export async function getStudyDetail(
  ...
  const res = await apiClient.get<StudyDetail>(`/api/lectures/lecture/${studyId}`);
  return res.data;
}
...
export async function createStudy(
  ...
  const res = await apiClient.post<Study>('/api/lectures/new', payload);
  return res.data;
}
...
export async function createStudyComment(
  ...
  const res = await apiClient.post<StudyComment>(
    `/api/lectures/lecture/${studyId}/comments`,
    { content }
  );
